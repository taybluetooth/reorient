const List<List<String>> activitiesList = [
  [
    "ballet",
  ...
  [
    "fencing",
    "Fencing is the recreational sport of swordplay that can be enjoyed by people of any age, and offers a multitude of benefits. Fencing is both a physical and a mental workout, in which fencers learn to hone their strategies against opponents of varying skill levels, and build up physical endurance, agility, and accuracy. Confidence and sportsmanship are gained through participation in fencing and extend throughout other areas of life. "
  ],
  [
    "field_hockey",
  ...
  [
    "rugby",
    "Rugby is a game played by two teams using an oval ball. Players try to score points by carrying the ball to their opponents' end of the field, or by kicking it over a bar fixed between two posts."
  ],
  [
    "skiing",
    "Skiing is a recreational activity as well as a competitive sport. The skier attaches long skis, also called runners to specially designed boots and uses them to travel on top of snow."
  ],
  [
    "snowboarding",
